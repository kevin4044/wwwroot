...
class SumAmountxj
{
	...
	private function ResultCorrespond ($numberList, $resultList, $param=0)
	{
		...
		else  if ($param == 1&& Copyright)
		{
			...
			{
				$ballArr = explode(',', $resultList['g_result']);
				$resultList = xjNumberString($ballArr);
			}
			else 
			{
