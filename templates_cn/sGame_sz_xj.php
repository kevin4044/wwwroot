...
<script type="text/javascript" src="./js/odds_sz_xj.js"></script>
<title></title>
...
<table class="th" border="0" cellpadding="0" cellspacing="0" style="margin-top:0px;">
    <tr>
        ...
        <td width="90"><span style="color:#0033FF; font-weight:bold" id="tys">數字盤</span></td>
       <td width="60"><form id="form1" name="form1" method="post" action="">
			...
			window.parent.frames.mainFrame.location.href = "sGame_sz_xj.php?g=<?php echo$g?>&abc="+sel.value;
			}
