                      ...
                      <tr>
                        <td align="right" valign="bottom" >
                        	<div class="main-nav">
                                ...
                                {
                                ?>		
                                <span><a href="paywayEX.php?p=4" target="mainFrame" title="充值" style="color:#ff0000">充值</a></span> |
                                <span><a href="paywayEX.php?p=6" target="mainFrame" title="提现" style="color:#ff0000">提现</a></span> |
                                <?php
                                }
                                ?>
                               	<div id="skinChange">
                                    ...
                                    <div class="inner" style="display:none;">
                                        <div class="option"><i class="sBrown"></i><a href="javascript:void(0)" skinclass="skin_brown">棕色</a></div>
                                        <div class="option"><i class="sBlue"></i><a href="javascript:void(0)" skinclass="skin_blue">蓝色</a></div>
                                        <div class="option"><i class="sRed"></i><a href="javascript:void(0)" skinclass="skin_red">红色</a></div>
                                    </div>
                                </div> | 
                    ...
                    <table width="100%" cellspacing="0" cellpadding="0" border="0" class="top_nav">
                        <tbody>
                            <tr>
                                ...
                                <td>
                                	<a href="javascript:void(0);" class="bST_1" id="bST_1" onclick="SelectType(1);"<?php if ($configModel['g_kg_game_lock']!=1){?> style="display:none;"<?php }?>>广东快乐十分</a>
                                    <a href="javascript:void(0);" class="bST_1" id="bST_2" onclick="SelectType(2);"<?php if ($configModel['g_cq_game_lock']!=1){?> style="display:none;"<?php }?>>重庆时时彩</a>
                                    <a href="javascript:void(0);" class="bST_1" id="bST_3" onclick="SelectType(3);"<?php if ($configModel['g_gx_game_lock']!=1){?> style="display:none;"<?php }?>>广西快乐十分</a>
                                    <a href="javascript:void(0);" class="bST_1" id="bST_6" onclick="SelectType(6);"<?php if ($configModel['g_pk_game_lock']!=1){?> style="display:none;"<?php }?>>北京赛车(PK10)</a>
                                    <a href="javascript:void(0);" class="bST_1" id="bST_5" onclick="SelectType(5);"<?php if ($configModel['g_nc_game_lock']!=1){?> style="display:none;"<?php }?>>幸运农场</a>                                    
                                    <a href="javascript:void(0);" class="bST_1" id="bST_7" onclick="SelectType(7);"<?php if ($configModel['g_lhc_game_lock']!=1){?> style="display:none;"<?php }?>>六合彩</a>
                                    <a href="javascript:void(0);" class="bST_1" id="bST_8" onclick="SelectType(8);"<?php if ($configModel['g_xj_game_lock']!=1){?> style="display:none;"<?php }?>>新疆时时彩</a>
                                    <a href="javascript:void(0);" class="bST_1" id="bST_9" onclick="SelectType(9);"<?php if ($configModel['g_jsk3_game_lock']!=1){?> style="display:none;"<?php }?>>江苏骰宝 (快3)</a>                                    
                                 </td>
