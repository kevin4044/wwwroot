...
function SelectType(LT) {
	...
	if (LT==1){
		...
		document.getElementById("bST_9").className="bST_1";
		document.getElementById("body_backdrop").className="backdrop_1";
		document.getElementById("Type_List").innerHTML='<a href="sGame_lhc.php?g=g7" target="mainFrame" class="red">特码</a>&nbsp;|&nbsp;<a href="sGame_lhc.php?g=g1"  target="mainFrame" >正码一</a>&nbsp;|&nbsp;<a href="sGame_lhc.php?g=g2"  target="mainFrame" >正码二</a>&nbsp;|&nbsp;<a href="sGame_lhc.php?g=g3"  target="mainFrame" >正码三</a>&nbsp;|&nbsp;<a href="sGame_lhc.php?g=g4"  target="mainFrame" >正码四</a>&nbsp;|&nbsp;<a href="sGame_lhc.php?g=g5"  target="mainFrame" >正码五</a>&nbsp;|&nbsp;<a href="sGame_lhc.php?g=g6"  target="mainFrame" >正码六</a>&nbsp;|&nbsp;<a href="sGame_lhc.php?g=g8"  target="mainFrame" >正码</a>&nbsp;|&nbsp;<a href="sGame_lhc_bo.php?g=g9"  target="mainFrame" >半波</a>&nbsp;|&nbsp;<a href="sGame_lhc_bo.php?g=g10"  target="mainFrame" >五行</a>&nbsp;|&nbsp;<a href="sGame_lhc_bo.php?g=g11"  target="mainFrame" >特码生肖</a>&nbsp;|&nbsp;<a href="sGame_lhc_bo.php?g=g12"  target="mainFrame" >一肖</a>&nbsp;|&nbsp;<a href="sGame_lhc_wei.php?g=g13"  target="mainFrame" >特尾</a>&nbsp;|&nbsp;<a href="sGame_lhc_wei.php?g=g14"  target="mainFrame" >尾数</a>&nbsp;|&nbsp;<a href="sGame_lhc_bo.php?g=g15"  target="mainFrame" >特码头</a>&nbsp;|&nbsp;<a href="sGame_lhc_l.php?g=g17"  target="mainFrame" >连码</a>&nbsp;|&nbsp;<a href="sGame_lhc_x.php?g=g18"  target="mainFrame" >合肖</a>';
...
H_Jeu1+="<tr><td align='center' class='t_list_caption' colspan='2'><strong>下注结果反馈</strong></td></tr>";
H_Jeu1+="<tr><td class='t_td_caption_1' width='65'>会员帐户</td>";
H_Jeu1+="<td class='t_td_text' width='166'>";
var H_Jeu2="</td></tr><tr><td class='t_td_caption_1'>可用金额</td><td id='Money_KY_1' class='t_td_text'>";
...
var H_Jeu5="<tr><td class='t_td_caption_1'>下注笔数</td><td class='t_td_text'>";
var H_Jeu6="&nbsp;笔</td></tr><tr><td class='t_td_caption_1'>閤计注额</td><td class='t_td_text'>￥";
var H_Jeu7="</td></tr></table><br><br>";
var MX_Jeu1="<tr><td align='center' class='t_td_odd_1' colspan='2' height='74' valign='middle'><table border='0' cellpadding='0' cellspacing='0' width='100%'><tr><td align='center' height='16' width='26%'>注单号：</td><td width='74%'>";
...
var MX_Jeu4="</span></td></tr><tr><td align='center' height='16'>下注额：</td><td>";
var MX_Jeu5="</td></tr><tr><td align='center' height='16'>可赢额：</td><td>";
