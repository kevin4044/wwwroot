...
$ccd=isBallTypexjsz($s_cq[0][0],$s_cq[0][1]);
...
$gMoney = $max['KeYongEr'];
$s = isBallTypexjsz($s_cq[0][0], $s_cq[0][1]);
?>
...
<body>
<form id="dp" action="inc/DataProcessingxjsz.php" method="post" onsubmit = "return submitformscq()">
